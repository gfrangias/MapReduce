...
public class ZNodeController implements Watcher {
    ...
    public String getLeadingMonitorIP() {
        return leadingMonitorIP;
    }

    public void setLeadingMonitorIP(String leadingMonitorIP) {
        this.leadingMonitorIP = leadingMonitorIP;
    }
    ...
    public String getStringData(String znode) throws Exception {
        // Add a watch to the znode
        return new String(zk.getData(znode, this, null));
    }
